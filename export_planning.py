...
TABLES = {
    # Courses carry course-level policy not derivable from the inputs: the title
    # and the primary_reference/primary_outline pointers. (Reference nodes are
    # still regenerated by load_nodes; only this course row is authored state.)
    "courses": (["course", "title", "primary_reference", "primary_outline"],
                ["course"], None),
